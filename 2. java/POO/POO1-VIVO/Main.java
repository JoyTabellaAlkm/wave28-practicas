public class Main {
    public static void main(String[] args) {
         ...
         * las variables donde vas a asignar cada objeto. ¿Cómo lo harías? A
         * continuación
         * vamos a crear otro objeto de tipo persona y vamos a construirlo pasando
         * solamente
         * un valor para el nombre y otro para la edad en el constructor. ¿Es esto
         * posible?
        ...
        // Persona persona4=new Persona("Lucas", 22); --> no se puede porque no existe
        // un constructor para este formato.
         ...
         * También vamos a averiguar si es mayor de edad o no; ten en cuenta que en
         * ambos casos,
         * dependiendo de los resultados retornados por los métodos, debes imprimir un
         * mensaje acorde
         * para el usuario.
         * Finalmente queremos mostrar todos los datos de esa persona imprimiendo dicha
         * información por consola. El formato en que vas a mostrar los datos y los
         * mensajes quedan a tu criterio,
