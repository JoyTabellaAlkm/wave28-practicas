...
public class Temperaturas {
    public static void main(String[] args) {
        ...
        System.out.println("La menor temperatura registrada es: "+ ciudades[menorIndex]+" : "+menorVal);
        System.out.println("La mayor temperatura registrada es: "+ ciudades[mayorIndex]+" : "+mayorVal);
    }
}
