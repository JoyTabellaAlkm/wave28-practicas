...
public class Persona {
    ...
    uno sin parámetros, el segundo debe recibir como parámetro nombre, edad y dni;
    ...
    la fórmula para calcularlo es: peso/(altura^2) - (peso expresado en kg y altura en mts),
     ...
     número entre 20 y 25 inclusive para los dos valores, el metodo debe retornar un 0,
     por último, si devuelve un número mayor que 25 debe retornar un 1. Una vez creado el
      metodo anterior, agreguemos el metodo esMayorDeEdad() el cual debe retornar una valor
      booleano, teniendo en cuenta que la mayoría de edad será considerada en este caso, a
