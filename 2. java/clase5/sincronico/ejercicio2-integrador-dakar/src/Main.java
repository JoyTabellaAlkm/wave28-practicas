...
public class Main {
    public static void main(String[] args) {
        ...
        //Probando clase que socorre ambos tipos de clases
        Socorrista socorrista = new Socorrista();

        //Socorriendo con clases especificas para cada tipo
        socorristaMoto.socorrer(moto1);
        socorristaAuto.socorrer(auto2);

        //Socorriendo con una clase que abarca ambos tipos
        socorrista.socorrer(moto1);
        socorrista.socorrer(auto2);
    }
}