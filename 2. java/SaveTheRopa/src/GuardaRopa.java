...
public class GuardaRopa {
    ...
    public void mostrarPrendas2(){
        ...
        for (Map.Entry<Integer, List<Prenda>> guardaRopa: diccionario.entrySet()){
            System.out.println("Nº identificador: " + guardaRopa.getKey() + " y su lista de Prendas es: " + guardaRopa.getValue());
        }
    }
