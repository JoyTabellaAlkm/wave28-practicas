...
public class Main {
    public static void main(String[] args) {
        ...
        HashMap<String, Object> inscription1 = registeredParticipants(participant2, midCircuit);
    ...
    public static HashMap<String, Object> registeredParticipants(HashMap<String, Object> participant, HashMap<String, Object> category) {
