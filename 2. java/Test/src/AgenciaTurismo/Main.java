...
public class Main {
    public static void main(String[] args) {
        ...
        //Total ventas
        System.out.println("El total de ventas es:"+repositorioClientes.totalVentas());

        //Promedio ventas
        System.out.println("El promedio de ventas es:"+repositorioClientes.promedioVentas());
