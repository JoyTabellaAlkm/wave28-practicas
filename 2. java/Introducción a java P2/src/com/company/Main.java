...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> listaCategorias = new ArrayList<List<String>>();
        Map<Integer, Map<String, Object>> participantes = new HashMap<Integer, Map<String, Object>>();
        Map<String,Map<String, String>> categorias = new HashMap<String,Map<String, String>>();
        ...
        while (!inscripcionCerrada) {
            ...
            switch (opciones) {
                case 1:
                    ...
                    String nombreCategoria = console.nextLine();
                    System.out.print("Ingrese la descripción de la categoria: ");
                    String descripcionCategoria = console.nextLine();

                    List<String> listaCategoria = new ArrayList<String>();
                    listaCategoria.add(id);
                    listaCategoria.add(nombreCategoria);
                    listaCategoria.add(descripcionCategoria);

                    listaCategorias.add(listaCategoria);
                ...
                case 2:
                    ...
                    System.out.print("Ingrese categoria chico 1. medio 2. avanzado 3.");
                    int categoria = Integer.parseInt(console.nextLine());

                    String montoAAbonar = "";
                    switch (categoria){
                        case 1:
                            montoAAbonar = edad <= 18 ? "$1300" : "$1500";
                            break;
                        case 2:
                            montoAAbonar = edad <= 18 ? "$2000" : "$2300";
                            break;
                        case 3:
                            montoAAbonar = "$2800";
                            break;
                    ...
                    datosParticipante.put("Categoria", categoria);
                    datosParticipante.put("MontoAPagar", montoAAbonar);
