...
import org.example.modelos.ETipoReserva;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("TOTAL SIN DESCUENTO " + localizador1.getMontoTotal());
        localizador1.aplicarDescuento();
        System.out.println("TOTAL CON DESCUENTO " + localizador1.getTotalConDescuento());
        ...
        System.out.println("TOTAL SIN DESCUENTO " + localizador2.getMontoTotal());
        localizador2.aplicarDescuento();
        System.out.println("TOTAL CON DESCUENTO " + localizador2.getTotalConDescuento());

        localizador3.agregarReserva(new Reserva(10, ETipoReserva.Comida, cliente));

        System.out.println("LOCALIZADOR3");
        System.out.println("TOTAL SIN DESCUENTO " + localizador3.getMontoTotal());
        localizador3.aplicarDescuento();
        System.out.println("TOTAL CON DESCUENTO " + localizador3.getTotalConDescuento());
    }
}