...
public class Main {
    public static void main(String[] args) {
        ...
        List<Vehiculo> vehiculosOrdenadosXMayor =  vehiculoList.stream().sorted((v1,v2) -> v2.getCosto() - v1.getCosto() ).toList();
        List<Vehiculo> vehiculosOrdenadosXMenor =  vehiculoList.stream().sorted((v1,v2) -> v1.getCosto() - v2.getCosto() ).toList();
        System.out.println("VEHICULOS ORDENADOS DE MENOR A MAYOR: ");
        vehiculosOrdenadosXMenor.forEach(System.out::println);
        ...
        vehiculosOrd.forEach(System.out::println);
        ...
        System.out.println("Precio promedio de todos los vehiculos: " + String.format("%.2f", precioPromedio));
    }
}