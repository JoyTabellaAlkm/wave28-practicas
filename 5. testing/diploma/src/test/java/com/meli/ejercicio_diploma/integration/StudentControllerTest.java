...
public class StudentControllerTest {
    ...
    public static void init() {
        ...
        student = new StudentDTO(
                2L,
                "Carlos",
                "El alumno Carlos ha obtenido un promedio de 9,00. Felicitaciones!",
                9.0,
                List.of(
    ...
    public void testModifyStudent() throws Exception {
        student.setStudentName("Carlos Modificado");
        ...
        mockMvc.perform(get("/student/getStudent/{id}", 2))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.studentName").value("Carlos Modificado"));
    }
