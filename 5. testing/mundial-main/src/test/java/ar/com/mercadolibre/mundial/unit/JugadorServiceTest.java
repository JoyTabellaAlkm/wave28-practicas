...
class JugadorServiceTest {
    ...
    @Test
    @DisplayName("Validar que se agregó el jugador Juanchope")
    void validarAgregadoJugadorJuanchope(){
        Jugador nuevo = new Jugador(22, "Juan Chope", "Argentina", 30);
        when(jugadorRepository.agregarNuevoJugador(nuevo)).thenReturn(21);
        Jugador j = jugadorService.agregarNuevoJugador(nuevo);
        assertEquals(nuevo,j);
    }

//    @Test
//    @DisplayName("Validar que se eliminó")
//    void validarAgregadoJugadorJuanchope(){
//        Jugador nuevo = new Jugador(22, "Juan Chope", "Argentina", 30);
//        when(jugadorRepository.agregarNuevoJugador(nuevo)).thenReturn(21);
//        Jugador j = jugadorService.agregarNuevoJugador(nuevo);
