...
public class JugadorServiceImpl implements JugadorService {
    ...
    public Jugador crearJugador(int id, String nombre, String pais, int goles){
        Jugador jugador = new Jugador(id, nombre, pais, goles);
        jugadorRepository.guardarJugador(jugador);
        System.out.println(obtenerJugadoresOrdenadosPorGoles().size());
        return jugador;
    }
}
