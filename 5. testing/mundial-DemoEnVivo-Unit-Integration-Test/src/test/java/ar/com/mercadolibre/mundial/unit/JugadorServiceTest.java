...
class JugadorServiceTest {
    ...
    @Test
    void test_registrar_jugador_ok() {

        // ARRANGE
        MensajeDTO expected = new MensajeDTO("Jugador registrado");
        ...
        // ACT
        MensajeDTO actual = jugadorService.registrarJugador(jugador);
    ...
    @Test
    void test_registrar_jugador_should_throw_excepction_when_id_already_exists() {
