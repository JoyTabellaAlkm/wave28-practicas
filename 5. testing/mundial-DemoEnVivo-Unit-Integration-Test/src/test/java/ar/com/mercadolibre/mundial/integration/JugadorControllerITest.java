...
public class JugadorControllerITest {
    ...
    @Test
    void registrarJugadorTestOK() throws Exception {
        ...
        String payload = objectMapper.writeValueAsString(jugadorDTO);

        MensajeDTO expectedMsg = new MensajeDTO("Jugador registrado");

        ResultMatcher expectedBody = content().json(objectMapper.writeValueAsString(expectedMsg));
        ...
        mockMvc.perform(post("/jugador")
                ...
                .andExpectAll(
                        expectedBody, expectedContentType, expectedStatus
                )
                .andDo(print());
    ...
    @Test
    void registrarJugadorTestException() throws Exception {

        // ARRANGE
        String payload = objectMapper.writeValueAsString(jugador1);

        ErrorDTO expectedError = new ErrorDTO("Ya existe un jugador con este ID");
    ...
    void obtenerJugadorPorNombreOK() throws Exception {
        ...
        // ARRANGE
        ResultMatcher expectedBody = content().json(objectMapper.writeValueAsString(jugador1));
        ResultMatcher expectedContentType = content().contentType(MediaType.APPLICATION_JSON);
        ResultMatcher expectedStatus = status().isOk();

        // ACT
        mockMvc.perform(get("/jugador").queryParam("nombre", jugador1.getNombre()))
                .andExpectAll(
                        expectedBody, expectedContentType, expectedStatus
                )
                .andDo(print());
    ...
    @Test
    void obtenerJugadorPorNombreException() throws Exception {

        // ARRANGE
        ErrorDTO expectedError = new ErrorDTO("Jugador no encontrado");
        ...
        // ACT
        mockMvc.perform(get("/jugador").queryParam("nombre", ""))
                .andExpectAll(expectedBody, expectedContentType, expectedStatus)
                .andDo(print());
