...
$(document).ready(function() {
    ...
    $('.global-header .hamburger-menu').click(function() {
        ...
        $mainContainerOpacity = $('.main-container-opacity');
        if ($mobileMenu.is(':visible')) {
            $mobileMenu.addClass('hidden');
            $hamburgerMenu.attr('aria-expanded', 'false');
            $mainContainerOpacity.addClass('hidden');
        } else {
            $mainContainerOpacity.removeClass('hidden');
    ...
    $('#language-select').click(function() {
        $('#language-selector').toggleClass('d-flex');
    })

    $("#language-selector a[href='#submit']").click(function() {
        $('#language-selector form').submit()
    })

    $("#language-selector a[href='#cancel']").click(function(ev) {
        $('#language-selector').toggleClass('d-flex');
    })
});
