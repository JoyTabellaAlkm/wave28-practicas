...
import com.bootcamp.clothes.service.IClotheService;
...
public class ClotheController {
    ...
    @PutMapping("/{code}")
    public ResponseEntity<Clothe> updateClothe(@PathVariable Long code, @RequestBody Clothe Clothe) {
    ...
    @DeleteMapping("/{code}")
    public ResponseEntity<Void> deleteClothe(@PathVariable Long code) {
