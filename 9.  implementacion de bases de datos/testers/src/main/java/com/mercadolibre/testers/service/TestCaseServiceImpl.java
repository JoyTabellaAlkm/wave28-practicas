...
public class TestCaseServiceImpl implements ITestCaseService{
    ...
    @Override
    public MessageDTO createCaseTest(CreateTestCaseDTO test) {
    ...
    @Override
    public List<TestCaseDTO> findAllCase() {
    ...
    @Override
    public TestCaseDTO findCaseById(Long id) {
    ...
    @Override
    public MessageDTO updateCase(Long id, CreateTestCaseDTO test) {
        TestCase testCase = testCaseRepository.findById(id).orElse(null);
        if(testCase == null){
    ...
    @Override
    public MessageDTO deleteCase(Long id) {
        testCaseRepository.deleteById(id);
        return new MessageDTO("TestCase con identificatorio " + id + " actualizado exitosamente.");
    }

    @Override
    public List<TestCaseDTO> findByDate(LocalDate date) {
        testCaseRepository.findByLastUpdateBefore()
    }
}
