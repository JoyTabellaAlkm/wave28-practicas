...
public class VehiculoController {
    ...
    @GetMapping("/patente")
    public ResponseEntity<List<String>> traerTodasLasPatentes(){
        return ResponseEntity.ok(vehiculosService.findAllPlates());
    }

    @GetMapping("/patente-marca-by-ano")
    public ResponseEntity<List<VehiculoPatenteYMarcaResponseDTO>> traerTodasLasPatentesYMarcas(){
        return ResponseEntity.ok(vehiculosService.findAllPatenteYMarcaByYear());
    }
}
