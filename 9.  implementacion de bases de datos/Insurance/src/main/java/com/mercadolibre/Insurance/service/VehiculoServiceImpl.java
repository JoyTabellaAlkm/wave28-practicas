...
public class VehiculoServiceImpl implements IVehiculosService{
    ...
    public List<String> findAllPlates(){
        return vehiculoRepository.findAllPatententes();
    }

    @Override
    public List<VehiculoPatenteYMarcaResponseDTO> findAllPatenteYMarcaByYear(){
        return vehiculoRepository.findAllPatenteYMarcasByAno();
    }
}
