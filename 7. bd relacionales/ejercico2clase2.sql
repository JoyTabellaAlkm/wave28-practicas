...
-- Listar nombres de los estudiantes a los que se prestaron libros de Base de Datos. TERMINAR
-- Listar los libros que pertenecen a la autora J.K. Rowling. TERMINAR
-- Listar títulos de los libros que debían devolverse el 16/07/2021. TERMINAR
