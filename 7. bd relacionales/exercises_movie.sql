...
SELECT nombre_pelicula, rating FROM peliculas ORDER BY rating DESC LIMIT 5;
...
SELECT title FROM movies WHERE release_date BETWEEN "2002-01-01" AND "2008-12-31";
