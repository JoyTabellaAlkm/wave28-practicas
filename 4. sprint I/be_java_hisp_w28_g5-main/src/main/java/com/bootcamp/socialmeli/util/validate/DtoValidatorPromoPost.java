...
public class DtoValidatorPromoPost {
    public static void validatePromoPostCreation(PostPromoRequestDto postDto) {
        ...
        if (postDto.isHasPromo() && (postDto.getDiscount() == null || postDto.getDiscount() <= 0)) {
            error.append("If there is a discount, its value must not be null or less than zero;");
        }
