...
public class UserServiceImpl implements UserService {
    ...
    public GetFollowedDTO getFollowedByUserId(Long id, Optional<String> order) {
        ...
        if (order.isEmpty()){
        ...
        } else if (order.get().equals("name_asc")) {
            ...
            throw new OrderValidException("Invalid Sort order");
        }
    }
    ...
    public GetFollowersDTO getFollowersByUserId(Long id, Optional<String> order) {
